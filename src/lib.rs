...
// V2 migration (April 22, 2026): Polymarket replaced the V1 CTF Exchange +
// USDC.e collateral pair with the V2 CTF Exchange backed by pUSD (an ERC-20
// USDC wrapper). Orders signed against V1 contracts no longer settle, and
// maker/taker tokens on a V2 market are pUSD, not USDC.e.
