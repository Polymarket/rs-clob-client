...
//!
//! This module contains all response types returned by Data API endpoints.
//! Each type corresponds to the JSON schema documented in the `OpenAPI` specification.
