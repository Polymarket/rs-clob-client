...
//! outcome tokens ("YES" and "NO") backed by pUSD collateral (Polymarket's USDC-backed
//! ERC-20 wrapper; see `CollateralOnramp`/`CollateralOfframp` to wrap/unwrap USDC.e).
//!
//! # Features
//!
